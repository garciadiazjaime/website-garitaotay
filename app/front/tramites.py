	...
	def dmv(self, lang=0):
		data = [
			...
			[
				{
					'id_': 'dmv_default',					
					'desc': '<p>Our service to the Department of Motor Vehicles is timely and professional. We assist you in processing your records, change of name requests as well as other important filings.</p><p> You will avoid lengthy lines, complicated paperwork and will have the satisfaction of processing your requests in a timely manner.</p>',
					'class': '',
				},
				{
					'id': 'dmv_renovacion',
					'title': 'Renewals, Partials, Auto and Commercial',
					'desc': 'It is very important to have a valid vehicle registration in the state of California. You will avoid setbacks, fines or the towing of your vehicle. We will assist you in a timely manner and will also help you to avoid lengthy lines and unnecessary payments in many cases.',
					'class': '',
				},
				{
					'id': 'dmv_verificacion',
					'title': 'Trailer Verification before the DMV',
					'desc': 'Avoid lengthy lines to verify your box or tractor. We have the DMV Verification License. It is required to verify before the DMV when the serial number is unreadable or does not coincide with the chassis or cabin.',
					'class': '',
				},
				{
					'id': 'dmv_duplicado_registro',
					'title': 'Duplicates, Plates and Decals',
					'desc': 'Loss of plates and vehicle registration or having your monthly or yearly decals stolen from the plate is pretty frequent. You may request a replacement through our Processing Department.',
					'class': '',
				},
				{
					'id': 'dmv_registro',
					'title': 'Mexican Flatbed/Box Registration in California',
					'desc': 'According to the regulation between the transportation departments in the DMV and SCT (Mexico), we can file the registration of any Mexican registered trailer, box or platform. You may request your California plate and enjoy a 6-year period of free travel, hassle free.',
					'class': '',
				},
				{
					'id': 'dmv_cambios',
					'title': 'Changing Ownership, Application for New and Non-Operating Registrations',
					'desc': 'Servicios Garita Otay will efficiently help you process your first-time registration for a new vehicle or commercial vessel, as well as process your payments to cover the necessary fees to obtain your registration and plates. In the case of Baja California, we notify the DMV about the sale, gift or loss of your unit by which you protect your vehicle before the agency.',
					'class': 'two_lines',
				},				
				{
					'id': 'dmv_duplicado_titulo',
					'title': 'Title Duplicates',
					'desc': 'We can help you get a title duplicate for your vehicle or commercial vessel before the DMV. Through our services, you may avoid months of delays in your paperwork as well as avoid incurring unnecessary payments.',
					'class': '',
				},
			]
		]		
		...
		data = [
			...
			[
				...
				},			
				{
					...
					'desc': 'Program established in 2007 to raise funds based on the number of freight units in each transportation company or transportation registration. Funds are directed to the implementation of programs unique to the sector.',
				},																	
				{
					'id': 'eu_fast',
					'title': 'FAST',
